...
class npc(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(
            config['PATH'] if 'PATH' in config else "", "/home/leesum/workhome/ysyx/npc/obj_dir/Vtop")
    ...
    def build(self, isa_yaml, platform_yaml):
        ...
        # for npc start building the '--isa' argument. the self.isa is dutnmae specific and may not be
        # useful for all DUTs
    ...
    def runTests(self, testList):
        ...
        for testname in testList:
            ...
            if self.target_run:
                ...
                simcmd = self.dut_exe + \
                    ' {0}  {1}  {2}'.format(
                        os.path.join(test_dir,binfile), libnemu, sig_file)
            else:
                simcmd = 'echo "NO RUN"'
