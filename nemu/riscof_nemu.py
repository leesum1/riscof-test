...
class nemu(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # /home/leesum/workhome/ysyx/nemu/build/riscv64-nemu-interpreter -l /home/leesum/workhome/ysyx/nanos-lite/build/nemu-log.txt -b  --diff=/home/leesum/workhome/ysyx/nemu/tools/spike-diff/build/riscv64-spike-so /home/leesum/workhome/ysyx/test/riscv-tests/build/bin/rv64ui-p-ma_data.bin

        self.dut_exe = os.path.join(
            config['PATH'] if 'PATH' in config else "",
            "/home/leesum/workhome/ysyx/nemu/build/riscv64-nemu-interpreter \
             -b  --diff=/home/leesum/workhome/ysyx/nemu/tools/spike-diff/build/riscv64-spike-so ")
    ...
    def initialise(self, suite, work_dir, archtest_env):
        ...
        self.objcopy_cmd = 'riscv{1}-unknown-elf-objcopy -O binary {0}  {2}'
    ...
    def build(self, isa_yaml, platform_yaml):
        ...
        # for nemu start building the '--isa' argument. the self.isa is dutnmae specific and may not be
        # useful for all DUTs
    ...
    def runTests(self, testList):
        ...
        for testname in testList:
            ...
            libnemu = '/home/leesum/workhome/ysyx/nemu/libnemu.so'
            ...
            if self.target_run:
                ...
                simcmd = self.dut_exe + \
                    '  --signature={0}  {1} '.format(
                        sig_file,
                        os.path.join(test_dir, binfile))
            else:
                simcmd = 'echo "NO RUN"'

            # concatenate all commands that need to be executed within a make-target.
            execute = '@cd {0}; {1}; {2}; {3}'.format(
                testentry['work_dir'], cmd, cmd2, simcmd)
